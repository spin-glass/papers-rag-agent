...
async def stream_message(question: str, index: InMemoryIndex) -> AsyncGenerator[Dict[str, Any], None]:
    """
    ...
    try:
        ...
        response = await asyncio.to_thread(process_message_with_routing, question, rag_index=index)
